        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-2">
          ...
          >
            ...
            <ul className="mt-4 space-y-3 text-white/80">
              ...
              <li className="flex items-center gap-2 hover:text-cyan-400 transition">
                <FaTasks className="text-cyan-400" /> Clear weekly tasks and
                reviews
              </li>
              <li className="flex items-center gap-2 hover:text-cyan-400 transition">
                <FaCodeBranch className="text-cyan-400" /> Modern stacks &
                real-world projects
              </li>
              <li className="flex items-center gap-2 hover:text-cyan-400 transition">
                <FaBriefcase className="text-cyan-400" /> Strong focus on
                employability
              </li>
            </ul>
