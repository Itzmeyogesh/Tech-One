  ...
  return (
    <header
      className={`fixed top-0 z-50 w-full transition-all ${
        scrolled ? 'backdrop-blur bg-white/5 border-b border-white/10' : 'bg-transparent'
      }`}
    >
      <nav className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <img src={logo} alt="Technical One Logo" className="h-10 w-10 rounded-xl shadow-soft" />
          <span className="font-display text-xl tracking-wide">Technical <span className="gradient-text font-bold">One</span></span>
